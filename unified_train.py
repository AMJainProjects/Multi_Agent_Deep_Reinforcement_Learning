...
def train_maddqn(args):
    ...
    Returns:
        Trained MADDQN model and experiment directory
    """
    ...
    # Initialize MADDQN framework using factory
    ...
    # Use factory to create MADDQN with specified TimesNet type
    maddqn = create_maddqn(
        ...
        device=device,
        timesnet_type=args.timesnet_type
    )
...
def main():
    ...
    parser.add_argument('--tickers', type=str, default='DIA,SPY,QQQ',
                        help='Comma-separated list of tickers for mixed dataset')
